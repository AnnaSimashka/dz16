...
function ageClassification(n) {
    var n, str;
    n < 0 ? str = null : n <= 24 ? str = 'детский возраст' : n <= 44 ? str = 'молодой возраст' : n <= 65 ? str = 'средний возраст' : n <= 75 ? str = 'пожилой возраст' : n <= 90 ? str = 'старческий возраст' : n <= 122 ? str = 'долгожители' : str = null;
    return str;
};
